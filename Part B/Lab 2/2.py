...
Write a temperature converter python program, which is menu driven.
...
Provide an option to view the conversions stored as a list of tuples with attributes - from unit value, to unit value sorted by the user’s choice (from-value or to-value). 
"""
